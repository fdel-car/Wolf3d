...
/*   Updated: 2016/05/01 18:29:50 by fdel-car         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

int		ft_hexa_char_maj(char const *fl, va_list ap, t_glob *gl)
{
	gl->f = 2;
	gl->i = 0;
	if (fl[gl->l - gl->f] == 'h')
...
int		ft_hexa_short_maj(char const *fl, va_list ap, t_glob *gl)
{
	gl->f = 2;
	gl->i = 0;
	if (fl[gl->l - gl->f] == 'h')
...
int		ft_hexa_long_long_maj(char const *fl, va_list ap, t_glob *gl)
{
	gl->f = 2;
	gl->i = 0;
...
int		ft_hexa_long_maj(char const *fl, va_list ap, t_glob *gl)
{
	gl->f = 2;
	gl->i = 0;
