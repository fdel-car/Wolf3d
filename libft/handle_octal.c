...
/*   Updated: 2016/05/02 21:18:21 by fdel-car         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_octal_short(char const *fl, va_list ap, t_glob *gl)
{
	gl->f = 2;
	gl->i = 0;
	if (fl[gl->l - gl->f] == 'h')
...
int		ft_octal_long_long(char const *fl, va_list ap, t_glob *gl)
{
	gl->f = 2;
	gl->i = 0;
